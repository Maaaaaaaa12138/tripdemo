	...
	<view>
		...
		<view class="main">
			...
			<view class="item">
				...
				<input class="main-input" v-model="phoneData" placeholder="请输入邮箱" />
			</view>
			...
			<view class="item">
				...
				<view class="type">
					...
					<text class="senCode" @tap="sendMsg">{{sendCode}}</text>
				</view>
			</view>
			<view style="margin-top: 8px"></view>
			<view class="item">
				<image class="login_image" src="../../../static/login/password.png"></image>
				<view class="type"><input v-model="passData" class="main-input-code" maxlength="20" type="password" placeholder="请设置密码" /></view>
			</view>
		</view>
